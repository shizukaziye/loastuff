...
(function () {
  ...
  function inject() {
    ...
    el.innerHTML =
      ...
      '94.6 / 98.2 / 103.6 on their own fitted scale (support order weight comes from its own study). ' +
      'Letter bands were re-tuned to the new scale&apos;s percentiles: <b>S+ starts at the perfect 8-cost&apos;s ' +
      'grade</b> (96.1 DPS / 94.6 support), and below it each letter is an even third of its 10-point band ' +
